...
public class Q_0206 {
	...
	public static void main(String[] args) {
		...
		MethodExecuteTimeUtils.printRunTime(() -> System.out.println(reverseList(node4).val));

		MethodExecuteTimeUtils.printRunTime(() -> System.out.println(reverseList1(node4).val));

		MethodExecuteTimeUtils.printRunTime(() -> System.out.println(reverseList2(node4).val));
	}
